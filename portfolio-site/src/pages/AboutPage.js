    ...
    return (
        <div>
            ...
            <Content>
                ...
                <p>When I'm not busy coding, you can usually find me enjoying some of my favorite hobbies. These include meditation, yoga, weight-training, snowboarding, DJing, cooking, fishing, and traveling. Besides programming languages, I'm also currently teaching myself how to speak Spanish. Eventually I strive to be bilingual and add that to my dynamic skillset.</p>
            </Content>
        </div>
    );
