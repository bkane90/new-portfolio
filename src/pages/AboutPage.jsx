            ...
            <Container fluid={true}>
                <Row className="justify-content-center p-0">
                    ...
                    <Content>
                        ...
                        <p>When I'm not busy coding, you can usually find me enjoying some of my favorite hobbies. These include reading, meditation, yoga, weight-training, snowboarding, fishing, cooking, DJing, traveling, and jigsaw puzzles. Besides programming languages, I'm also currently learning how to speak Spanish. Eventually I strive to be bilingual and add that to my already dynamic skillset.</p>
                    </Content>
                </Row>
            </Container>
        </div>
